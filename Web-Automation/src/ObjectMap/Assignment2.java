...
public class Assignment2 {
	...
	static void ModifyUser()
	{
		try
		{
			...
			Thread.sleep(2000);
			//Modifying password
			oBrowser.findElement(objectmap.getLocator("passwordmodify1")).sendKeys("u1");
			Thread.sleep(2000);
			//Retyping modified  password
			oBrowser.findElement(objectmap.getLocator("retypingmodifiedpassword")).sendKeys("u1");
			Thread.sleep(2000);
			//Clicking Save Changes
			oBrowser.findElement(objectmap.getLocator("clickingsavechanges")).click();
			Thread.sleep(2000);
