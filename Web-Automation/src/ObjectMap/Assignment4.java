...
public class Assignment4 {
	...
	static void ModifyCustamer()
	{
		try
		{
			...
			Thread.sleep(2000);
			//Clicking custamer name label
			oBrowser.findElement(objectmap.getLocator("clickingcustamernamelabel")).click();
			Thread.sleep(2000);
			//entering modified name for custmer
			oBrowser.findElement(objectmap.getLocator("enetringmodifiedname")).sendKeys("2");
			Thread.sleep(2000);
			//Clicking Custamer list for saving change
			oBrowser.findElement(objectmap.getLocator("clickingcustamer1listforsaving")).click();
			Thread.sleep(2000);
