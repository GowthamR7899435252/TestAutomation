...
public class Assignment6 {
	...
	static void Modifyproject()
	{
		try
		{
		   //clicking project1 settings button
			oBrowser.findElement(objectmap.getLocator("clickingproject1settingsbutton")).click();
			Thread.sleep(2000);
			//clicking project name label
			oBrowser.findElement(objectmap.getLocator("clickingprojectnamelabel")).click();
			Thread.sleep(2000);
			//entering modified name to project name label
			oBrowser.findElement(objectmap.getLocator("enteringmodifiedname")).sendKeys("2");
			Thread.sleep(2000);
			//Clickiing again project list to save changes
			oBrowser.findElement(objectmap.getLocator("clickingprojectlistforsavingchanges")).click();
			Thread.sleep(2000);
