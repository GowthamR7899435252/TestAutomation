...
public class AdvancedAssignment1 {
	...
	public static void main(String[] args) {
		...
		loginasadmin();
		modifyingpasswordsofusers();
		
		loginlogoutforpasswordmodifiedusers();
		
		loginasadminfordeleting();
		deletingusers();
	...
	static void loginlogoutforusers()
	{
		try
		{
			// for user1
	...
	static void modifyingpasswordsofusers()
	{
		try
		{
			// for USER1
	...
	static void loginlogoutforpasswordmodifiedusers()
	{
		try
		{
			// for user1
	...
	static void loginasadminfordeleting()
	{
		try
		{
			oBrowser.findElement(By.id("username")).sendKeys("admin");
